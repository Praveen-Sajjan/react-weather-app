...
function App() {
  ...
  useEffect(()=>{
    ...
    axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${search}&appid=2fa73590fd8b5a4c6e68098ad5625395`).then((res)=>{
  ...
  return (
    ...
    <div className="weather-box">
        ...
        <div className="weather-cloud">
          <FeatherIcon icon="sun" color="white" stroke-width="2px" size="80"/>
        </div>
